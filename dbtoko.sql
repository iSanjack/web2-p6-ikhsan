...
(1, 'Pensil', 2000.00, 100),
(2, 'Buku Tulis', 5000.00, 50),
(3, 'Penghapus', 1500.00, 75),
(4, 'Rautan', 3000.00, 50),
(5, 'Karton', 10000.00, 3);
...
(1, 'Suroso', 'Krapyak Pekalongan'),
(2, 'Budi', 'Jalan Progro Pekalongan'),
(3, 'Citra', 'Keputeran Pekalongan'),
(4, 'wiee', 'Pencongan Wiradesa'),
(5, 'weee', 'Pencongan Wiradesa'),
(6, 'Myra', 'asfagag'),
(7, 'Jim', 'Pekalongan');
...
(1, 1, 1, 2, 4000.00, '2024-10-29 03:15:09'),
(2, 2, 2, 3, 15000.00, '2024-10-29 03:15:09'),
(3, 3, 3, 1, 1500.00, '2024-10-29 03:15:09');
...
(1, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'Administrator', 'admin'),
(2, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'user', 'kasir');
